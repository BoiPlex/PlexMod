...
public class NetherTridentEntity extends TridentEntity {
    ...
    public NetherTridentEntity(EntityType<? extends NetherTridentEntity> entityType, World world) {
        ...
        this.tridentStack = new ItemStack(ModItems.NETHER_TRIDENT);
    }
    ...
    public void tick() {
        ...
        if (i > 0 && (this.dealtDamage || this.isNoClip()) && entity != null) {
            if (!this.isOwnerAlive()) {
                ...
                // If touches water, turn block into stone
                if (this.getBlockStateAtPos() == Blocks.WATER.getDefaultState()) {
                    this.world.setBlockState(this.getBlockPos(), Blocks.STONE.getDefaultState());
                }
            }
        }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        this.world.setBlockState(entity.getBlockPos().add(0, -1, 0), Blocks.MAGMA_BLOCK.getDefaultState());
        this.world.setBlockState(entity.getBlockPos().add(0, 0, 0), Blocks.FIRE.getDefaultState());
    }
