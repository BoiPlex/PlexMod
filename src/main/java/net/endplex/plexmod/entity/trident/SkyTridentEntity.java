...
public class SkyTridentEntity extends TridentEntity {
    ...
    public SkyTridentEntity(EntityType<? extends SkyTridentEntity> entityType, World world) {
        super(entityType, world);
        this.tridentStack = new ItemStack(ModItems.SKY_TRIDENT);
    }

    public SkyTridentEntity(World world, LivingEntity owner, ItemStack stack) {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (this.world instanceof ServerWorld && this.world.isThundering() && this.hasChanneling()) {
            ...
            if (this.world.isSkyVisible(blockPos)) {
                ...
                // Summon 3 lightning strikes and toggle weather to raining/thunder
                this.world.spawnEntity(lightningEntity);
                this.world.spawnEntity(lightningEntity);
                this.world.spawnEntity(lightningEntity);
                ((ServerWorld) this.world).setWeather(100, 100, !this.world.isRaining(), !this.world.isThundering());
        ...
        target.addStatusEffect(new StatusEffectInstance(StatusEffects.LEVITATION, 10, 1));
