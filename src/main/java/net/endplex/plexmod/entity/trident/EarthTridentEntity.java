...
public class EarthTridentEntity extends TridentEntity {
    ...
    public EarthTridentEntity(EntityType<? extends EarthTridentEntity> entityType, World world) {
        super(entityType, world);
        this.tridentStack = new ItemStack(ModItems.EARTH_TRIDENT);
    }

    public EarthTridentEntity(World world, LivingEntity owner, ItemStack stack) {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        for (int i = -1; i <= 1; i++) {
            for (int j = -1; j <= 1; j++) {
                for (int k = -1; k <= 1; k++) {
                    if (this.world.getBlockState(pos.add(i, j, k)) != Blocks.AIR.getDefaultState() &&
                            this.world.getBlockState(pos.add(i, j, k)) != Blocks.WATER.getDefaultState()) {
                        if (rand.nextBoolean())
                            this.world.setBlockState(pos.add(i, j, k), Blocks.COARSE_DIRT.getDefaultState());
                        else
