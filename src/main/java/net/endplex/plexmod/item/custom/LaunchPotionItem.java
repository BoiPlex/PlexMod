...
public class LaunchPotionItem extends Item {
    private static final int MAX_USE_TIME = 32;

    public LaunchPotionItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.LEVITATION, 25, 14));
        }
