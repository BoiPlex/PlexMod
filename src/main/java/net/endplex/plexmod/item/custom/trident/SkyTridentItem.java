...
public class SkyTridentItem extends TridentItem {

    public SkyTridentItem(Settings settings) {
        super(settings);
    }
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
            ...
            if (i >= 10) {
                ...
                if (j <= 0 || playerEntity.isTouchingWaterOrRain()) {
                    if (!world.isClient) {
                        ...
                        if (j == 0) {
                            SkyTridentEntity tridentEntity = new SkyTridentEntity(world, playerEntity, stack);
                    ...
                    if (j > 0) {
                        ...
                        // Riptide launch is 2 times faster
                        h *= n / m * 2;
                        k *= n / m * 2;
                        l *= n / m * 2;
        ...
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOW_FALLING, 50, 0));
    }

    @Override
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        // When melee hit, give target weakness
        target.addStatusEffect(new StatusEffectInstance(StatusEffects.LEVITATION, 10, 3));
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        // When holding right click, levitate user
