...
public class OceanTridentItem extends TridentItem {

    public OceanTridentItem(Settings settings) {
        super(settings);
    }
            ...
            if (i >= 10) {
                ...
                if (j <= 0 || playerEntity.isTouchingWaterOrRain()) {
                    if (!world.isClient) {
                        ...
                        if (j == 0) {
                            OceanTridentEntity tridentEntity = new OceanTridentEntity(world, playerEntity, stack);
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        // When melee hit, give target weakness
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        if (selected && (!user.hasStatusEffect(StatusEffects.DOLPHINS_GRACE) || !user.hasStatusEffect(StatusEffects.WATER_BREATHING))) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, 300, 1));
