...
public class EarthTridentItem extends TridentItem {

    public EarthTridentItem(Settings settings) {
        super(settings);
    }
            ...
            if (i >= 10) {
                ...
                if (j <= 0 || playerEntity.isTouchingWaterOrRain()) {
                    if (!world.isClient) {
                        ...
                        if (j == 0) {
                            EarthTridentEntity tridentEntity = new EarthTridentEntity(world, playerEntity, stack);
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        // When melee hit, give target poison
